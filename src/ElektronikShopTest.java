public class ElektronikShopTest {
    ...
    public static void billigsteTastaturTest_falsch() {
        ElektronikShop shop = new ElektronikShop();
    ...
    public static void teuersteGegenstandTest_falsch() {
        ElektronikShop shop = new ElektronikShop();
        int[] tastaturen = {15, 20, 10, 35};
        int[] usb_flash = {};
    ...
    public static void teuerstesLeistenTest_falsch() {
        ElektronikShop shop = new ElektronikShop();
        int[] usb_falsch = {};
        int budget = 30;
    ...
    public static void geldBetragTest_falsch() {
        ElektronikShop shop = new ElektronikShop();
        int budget = 60;
        int[] tastaturen = {40, 50, 60};
