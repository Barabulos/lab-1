...
public class SummeArrayTest {
    ...
    public static void testAddiereZweiZahlen3() {
        int[] zahl5 = {9, 8, 7};
        int[] zahl6 = {1, 2, 3, 4};
    ...
    public static void testSubtrahiereZweiZahlen_falsch() {
        int[] zahl7 = {1, 2, 3};
        int[] zahl8 = {4, 5, 6};
    ...
    public static void testMultipliziereMitEinerZiffer_flasch() {
    ...
    public static void testDividiereMitEinerZiffer_falsch() {
        int[] zahl12 = {1};
        int ziffer4 = 0;
